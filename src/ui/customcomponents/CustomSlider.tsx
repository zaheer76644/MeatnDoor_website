...
export function CustomSlider() {
	return (
		<section id="home" className="hero-area mx-0 bg-[#47141e] py-12">
			<div className="container mx-auto px-4">
				<div className="grid items-center md:grid-cols-2">
					{/* Left Content */}
					<div>
						<h1 className="mb-4 text-4xl font-bold text-white">Get Fresh Meat Delivered to Your Doorstep</h1>
						...
						<div className="flex gap-4">
							...
							<a
								...
								className="rounded-md border bg-white px-6 py-3 font-bold 
                text-[#47141e] transition hover:bg-[#ed4264] hover:text-white"
							>
								<i className="lni lni-apple mr-1"></i>
								App Store
							</a>
							...
							<a
								...
								target="_blank"
								className="rounded-md border border-white bg-[#47141e] px-6 py-3 font-bold 
                text-white transition hover:bg-[#ed4264]"
							>
								<i className="lni lni-play-store mr-1"></i>
								Google Play
							</a>
						</div>
					</div>
