	...
	return (
		<section className="mx-auto grid max-w-7xl p-8">
			...
			<form className="grid gap-2 sm:grid-cols-2 lg:grid-cols-8" action={addItem}>
				...
				<div className="flex flex-col pt-6 sm:col-span-1 sm:px-6 sm:pt-0 lg:col-span-5 lg:pt-16">
					<div>
						<h1 className="mb-4 flex-auto text-3xl font-medium tracking-tight text-[#47141e] ">
							{product?.name}
						</h1>
